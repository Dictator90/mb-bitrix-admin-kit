...
(function (exports,main_core_collections,main_core,main_core_events,main_loader) {
	...
	var Tab = /*#__PURE__*/function (_EventEmitter) {
	  ...
	  function Tab(_options) {
	    ...
	    _classPrivateMethodInitSpec(babelHelpers.assertThisInitialized(_this), _buildHeaderInner);
	...
	function _initHead2(headOptions) {
	  ...
	  if (main_core.Type.isDomNode(headOptions)) {
	    ...
	    innerHeader = _classPrivateMethodGet(this, _buildHeaderInner, _buildHeaderInner2).call(this, options);
	  } else {
	...
	var Tabs = /*#__PURE__*/function (_EventEmitter) {
	  ...
	  function Tabs(options) {
	    ...
	    _classPrivateMethodInitSpec$1(babelHelpers.assertThisInitialized(_this), _attachKeyboardNavigation);
	    _classPrivateMethodInitSpec$1(babelHelpers.assertThisInitialized(_this), _scrollHeaderIntoView);
	    _classPrivateMethodInitSpec$1(babelHelpers.assertThisInitialized(_this), _findById);
	    ...
	    _classPrivateFieldInitSpec$1(babelHelpers.assertThisInitialized(_this), _hashNavigation, {
	      writable: true,
	      value: false
	    });
	    _classPrivateFieldInitSpec$1(babelHelpers.assertThisInitialized(_this), _scrollable, {
	      writable: true,
	      value: true
	    });
	    _classPrivateFieldInitSpec$1(babelHelpers.assertThisInitialized(_this), _hashChangeHandler, {
	      writable: true,
	      value: null
	    });
	    ...
	    if (babelHelpers.classPrivateFieldGet(babelHelpers.assertThisInitialized(_this), _hashNavigation) && window.location.hash) {
	      ...
	      var hashTab = _classPrivateMethodGet$1(babelHelpers.assertThisInitialized(_this), _findById, _findById2).call(babelHelpers.assertThisInitialized(_this), hashId);
	      if (hashTab) {
	    ...
	    if (babelHelpers.classPrivateFieldGet(babelHelpers.assertThisInitialized(_this), _hashNavigation)) {
	      babelHelpers.classPrivateFieldSet(babelHelpers.assertThisInitialized(_this), _hashChangeHandler, function () {
	        var hashId = window.location.hash.slice(1);
	        var tab = _classPrivateMethodGet$1(babelHelpers.assertThisInitialized(_this), _findById, _findById2).call(babelHelpers.assertThisInitialized(_this), hashId);
	  ...
	  babelHelpers.createClass(Tabs, [{
	    ...
	    value: function activateItem(tab) {
	      ...
	      if (babelHelpers.classPrivateFieldGet(this, _items).has(tab) && babelHelpers.classPrivateFieldGet(this, _activeItem) !== tab) {
	        ...
	        _classPrivateMethodGet$1(this, _scrollHeaderIntoView, _scrollHeaderIntoView2).call(this, tab);
	    ...
	    value: function getContainer() {
	      ...
	      _classPrivateMethodGet$1(this, _attachKeyboardNavigation, _attachKeyboardNavigation2).call(this, headers);
	      return this.content;
	    }
	  }, {
	    key: "getItems",
...
}((this.MB.UI.Tabs = this.MB.UI.Tabs || {}),BX.Collections,BX,BX.Event,BX));
