...
final class FormData
{
    ...
    public function all(): array { return $this->validated ?: $this->normalized ?: $this->raw; }
    public function get(string $key, mixed $default = null): mixed { return $this->all()[$key] ?? $default; }
    public function set(string $key, mixed $value): void { $this->validated[$key] = $this->normalized[$key] = $value; }
