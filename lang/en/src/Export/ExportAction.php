...
$MESS['MB_ADMIN_KIT_EXPORT_FILTER_DISABLED'] = 'Export by filter is disabled for this action.';
$MESS['MB_ADMIN_KIT_EXPORT_UNSUPPORTED_FORMAT'] = 'Unsupported export format.';
$MESS['MB_ADMIN_KIT_EXPORT_TOO_MANY_ROWS'] = 'Too many rows to export. Maximum: #MAX#.';
