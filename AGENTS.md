...
## Agent addendum
- При изменениях документации по полям сохраняйте `docs/fields.md` как обзор fluent API с краткими примерами; внутренние runtime/getter-методы не описывайте как пользовательский API.
