...
final class TransactionManagerTest extends TestCase
{
    ...
    {
        $connection = new class { public array $calls = []; public function startTransaction(): void { $this->calls[] = 'start'; } public function commitTransaction(): void { $this->calls[] = 'commit'; } public function rollbackTransaction(): void { $this->calls[] = 'rollback'; } };
